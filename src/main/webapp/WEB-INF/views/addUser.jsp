...
<link href="http://getbootstrap.com/examples/jumbotron/jumbotron.css"
	...
	src="<spring:url value="/resources/js/javascript.js"/>"></script>
...
<body>
	...
	<form:form class="form-horizontal" align="center" justify-content="left" overflow="hidden" modelAttribute="user"
